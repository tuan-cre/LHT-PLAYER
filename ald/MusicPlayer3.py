...
class MusicPlayer:
    ...
    def create_widgets(self):
        ...
        # Configure uniform width for tabs with padding
        ...
        #                 relief="solid"  # Set border relief
        #                 )
        ...
        self.notebook.add(self.music_tab)
        self.notebook.add(self.lyrics_tab)
        self.notebook.add(self.video_tab)
